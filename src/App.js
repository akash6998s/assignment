...
import {
  ...
  Legend, Tooltip, BarChart, Bar, ScatterChart, Scatter
} from "recharts";
...
function App() {
  return (<div>
    <h1 className="heading">Scatter Chart</h1>

    <br /><br />

    <ResponsiveContainer width="100%" aspect={3}>
      <ScatterChart data={pdata} width={500} height={300} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
        <CartesianGrid strokeDasharray="3 3" />
        <XAxis dataKey="Color Intensity" interval={'preserveStartEnd'} />
        <YAxis />
        <Tooltip />
        <Legend />
        <Scatter type="monotone" dataKey="Hue" activeDot={{ r: 8 }} />
        </ScatterChart>
      </ResponsiveContainer>
    ...
    <ResponsiveContainer width="100%" aspect={3}>
      <BarChart width={730} height={250} data={pdata}>
        <CartesianGrid strokeDasharray="3 3" />
        <XAxis dataKey="Alcohol" interval={'preserveStartEnd'} />
        <YAxis />
        <Tooltip />
        <Legend />
        <Bar type="monotone" dataKey="Malic Acid" />
      </BarChart>
    </ResponsiveContainer>
